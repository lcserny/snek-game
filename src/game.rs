...
use crossterm::terminal::{Clear, ClearType, disable_raw_mode, enable_raw_mode, SetSize, size};
use rand::Rng;
...
impl Game {
    pub fn new(stdout: Stdout, width: u16, height: u16) -> Self {
        ...
        let random_direction = match rand::thread_rng().gen_range(0, 4) {
            0 => Direction::Up,
            1 => Direction::Right,
            2 => Direction::Down,
            _ => Direction::Left,
        ...
        Self {
            ...
            height,
            food: None,
            snake: Snake::new(Point::new(width / 2, height / 2), 3, random_direction),
            speed: 0,
            score: 0,
        }
    }
